 ...
 */
public class ValueTagReplacement extends InlineTagReplacement{

	private final static String TAG_NAME = "value";

	public ValueTagReplacement(String wrapperString) {
		super(TAG_NAME, wrapperString);
	}

	public ValueTagReplacement(String prefix, String suffix) {

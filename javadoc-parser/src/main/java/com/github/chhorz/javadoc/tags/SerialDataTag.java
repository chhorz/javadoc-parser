...
/**
 * Oracle documentation <a href="https://docs.oracle.com/en/java/javase/18/docs/specs/javadoc/doc-comment-spec.html#serialdata">@serialData</a> tag
 *
 * @author chhorz
 */
public class SerialDataTag extends StructuredTag {
	...
	public SerialDataTag() {
		super(TAG_NAME, new Segment(DATA_DESCRIPTION));
	}
